...
int main()
{
    ...
    plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", "inverted_pendulum_config", result.tmv_flowpipes, setting);
    
    // Plot cart velocity vs angular velocity (velocity space)
    plot_setting.setOutputDims("v", "omega");
    plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", "inverted_pendulum_velocity", result.tmv_flowpipes, setting);
    
    // Plot pendulum angle vs angular velocity (phase portrait)
    plot_setting.setOutputDims("theta", "omega");
    plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", "inverted_pendulum_phase", result.tmv_flowpipes, setting);
